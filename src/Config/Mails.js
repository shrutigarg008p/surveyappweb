...
module.exports = {
	...
	userRegistrationHindi: (email, token) => {
		...
		const mailOptions = {
			...
			html: '<p>इंडियापोल्स में आपका स्वागत है!\n' +
				' \n' +
				'\n' +
				' \n' +
				' \n' +
				...
				'\n' +
				' \n' +
				'प्रत्येक सर्वेक्षण को पूरा करने पर आप आकर्षक पुरस्कार अंक अर्जित करते हैं।  आप कई दूसरे पुरस्कारो के लिए अपने अर्जित अंक भुना सकते हैं। जिसमें Amazon या Flipkart या Paytm कैश के वाउचर भी शामिल हैं।\n' +
				' \n' +
				'\n' +
				' \n' +
				'\n' +
				' \n' +
				'मैं कुमार हूं, इस महान पैनल समुदाय के व्यवस्था के लिए जिम्मेदार हूं। मैं हमारे विशाल पैनल समुदाय में हमारे नवीनतम सदस्य के रूप में आपका स्वागत करने के लिए उत्साहित हूं और वास्तव में आशा करता हूं कि आगे की यात्रा में आपको एक सुखद एवं लाभान्वित अनुभव होगा। मैं आपको हमारी वेबसाइट, हमारे प्रोत्साहन कार्यक्रम और सर्वेक्षणों से परिचित होने में भी मदद करूंगा, जिन्हें आप समय-समय पर ले सकते हैं और पुरस्कार अर्जित कर सकते हैं।\n' +
				' \n' +
				'\n' +
				' \n' +
				'किसी भी प्रश्न, टिप्पणी या प्रतिक्रिया के मामले में कृपया निःसंकोच मुझसे संपर्क करें।\n' +
				' \n' +
				'\n' +
				' \n' +
				'अभी, अपनी पंजीकरण प्रक्रिया पूरी करने के लिए कृपया नीचे दिए गए लिंक पर क्लिक करें:\n' +
				' \n' +
				'\n' +
				' \n' +
				'\n' +
				'\t\t\t<a href="https://panel.indiapolls.com/#/auth/confirmed-email?email='+email+'&token='+token+'">ईमेल की पुष्टि करें</a>\n' +
				' \n' +
				'\n' +
				' \n' +
				'एक बार जब आप अपनी सदस्यता सक्रिय कर लेंगे तो आप सर्वेक्षण में भाग लेने और पुरस्कार अर्जित करने के उपयुक्त होंगे। आपकी सदस्यता बिल्कुल मुफ़्त है और आपका व्यक्तिगत डेटा कभी भी हमारे किसी भी व्यावसायिक सहयोगी के साथ साझा नहीं किया जाएगा। इसका उपयोग केवल आपके लिए व्यक्तिगत रूप से सर्वेक्षणों को चयन करने के लिए किया जाएगा।\n' +
				' \n' +
				'\n' +
				' \n' +
				'मैं आपकी सक्रिय भागीदारी की आशा करता हूँ। एक बार फिर इंडियापोल्स पर आपका स्वागत है। मुझे यकीन है कि आप यहां बहुत अच्छा समय बिताएंगे।\n' +
				' \n' +
				'\n' +
				' \n' +
				'आपका पोल इंडियापोल्स  में मदद करता है!\n' +
				' \n' +
				'\n' +
				' \n' +
				'सादर आभार\n' +
	...
	userEmailChangedHindi: (email, token) => {
		...
		const mailOptions = {
			...
			html: '<p>इंडियापोल्स में आपका स्वागत है!\n' +
				...
				'\n' +
				' \n' +
				'अभी, अपना परिवर्तन ईमेल पुष्टिकरण प्रक्रिया पूरी करने के लिए, कृपया नीचे दिए गए लिंक पर क्लिक करें:\n' +
				' \n' +
				'\n' +
				' \n' +
				'\n' +
