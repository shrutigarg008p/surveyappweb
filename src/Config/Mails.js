	...
	userRegistration: (email, token) => {
		...
		const mailOptions = {
			...
			html: '<p><strong><span style="font-family:Arial;color:rgb(0,0,0);font-weight:bold;font-size:16px;background:rgb(255,255,255);">Welcome to IndiaPolls !&nbsp;</span></strong></p>\n' +
				...
				'                  \n' +
				'                  <img src="http://ec2-52-66-172-238.ap-south-1.compute.amazonaws.com:9000/Images/logo.jpeg" alt="IndiaPolls" width="50" height="40">\n' +
				'                  \n' +
				'                  </span></strong><span style="font-family:Arial;color:rgb(0,0,0);font-size:13px;"><br></span><span style="font-family:Arial;color:rgb(0,0,0);font-size:13px;"><br></span><span style="font-family:Arial;color:rgb(0,0,0);font-size:13px;background:rgb(255,255,255);">Kumar,</span><span style="font-family:Arial;color:rgb(0,0,0);font-size:13px;"><br></span><span style="font-family:Arial;color:rgb(0,0,0);font-size:13px;background:rgb(255,255,255);">IndiaPolls - Panel Manager</span></p>',
