...
module.exports = {
	...
	userEmailChangedOld: (email, token) => {
		console.log('logIn_Mail====>' + email);
		const mailOptions = {
			from: 'panel@indiapolls.com',
			to: email,
	...
	userEmailChangedHindiOld: (email, token) => {
		console.log('logIn_Mail====>' + email);
		const mailOptions = {
			from: 'panel@indiapolls.com',
			to: email,
